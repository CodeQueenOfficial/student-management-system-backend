...
const editstudentProfile = async (req, res) => {
    ...
    try {
        ...
        res.json(updated);
       /*const token = jwt.sign({ _id: req.params.id }, process.env.JWT_SECRET);
        res.json(token);*/
...
module.exports = {createUser, loginUser, deleteUser, userProfile, 
    getEditStudentProfile, 
    editstudentProfile, forgotPassword, resetPassword, adminDashboard };
